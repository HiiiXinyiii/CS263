...
parser.add_argument('--fine_tuning_model', type=str, default='model10')
...
parser.add_argument("--source_max_length", type=int, default=50)        # Source text length
...
parser.add_argument("--alpha", type=int, default=1)         # initial learning rate
parser.add_argument("--start_halve", type=int, default=6)       # learning rate halve
