...
def format_data(data):
    ...
    system_instruction = (
        ...
        "You need to rate the generated response's fluency on a scale of 1 to 5, where "
        "1 indicates terrible fluency, 2 indicates not satisfying, 3 indicates standard, "
        "4 indicates satisfying, and 5 indicates very satisfying. "
        "Fluency includes how smoothly the response integrates with the conversation and its coherence. "
...
def format_friend_data(data):
    ...
    system_instruction = (
        "Assume you are a human annotator. "
        "You will be given the persona of the individual and the full conversation history from two sets of conversations. "
        "You need to rate the generated response's fluency on a scale of 1 to 5, where "
        "1 indicates terrible fluency, 2 indicates not satisfying, 3 indicates standard, "
        "4 indicates satisfying, and 5 indicates very satisfying. "
        "Fluency includes how smoothly the response integrates with the conversation and its coherence. "
...
def main():
    ...
    output_filepath = "score_fluency.json"
